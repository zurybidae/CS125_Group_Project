...
int main() //-----------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    do
	{
        ...
        scanf(" %c", &their_choice); 
		
		if (!isdigit(their_choice))
		{
			input=1;
			printf("That is not a number. Try Again.\n");
		}
		else if(their_choice=='1')
		{
			choice=1;
			input=0;
		}
		else if(their_choice =='2')
        {
            choice=2;
            input=0;
        }
        else if(their_choice =='3')
        {
            choice=3;
            input=0;
        }
...
void letter_bank_printer(char guess)
{
    for(x=0;x<26;x++)
    {
        if(strcmp(guess, letter_bank[i]))
        {
            //letter_bank[i]=' ';
        }
    }
...
int main() //-----------------------------------------------------------------------------------------------------------------------------------------
{
    FILE *point = fopen("alphabet.txt","a");
    fprintf(point,"abcdefghijklmnopqrstuvwxyz");
    fclose(point);

    
    char their_choice[MAX];
    int choice;
    printf("Welcome to Hangman!\n\n");
